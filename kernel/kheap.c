...
/**
 * @brief Lorsque tout le code du noyau est compilé, le tas du noyau commence
 * juste après.
 *
 */
...
void init_kheap() { placement_address = (uint32_t)&mem_heap; }

uint32_t get_kheap_placement_address() { return placement_address; }
